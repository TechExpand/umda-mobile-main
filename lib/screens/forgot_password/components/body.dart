      ...
      child: Column(
        children: [
          ...
          DefaultButton(
            text: "Continue",
            press: () {
              if (authProvider.resetemailController.text.isNotEmpty) {
                print(authProvider.resetemailController.text);
                circularCustom(context);
                 AuthProvider().forgetPasswordFunction(context, authProvider.resetemailController.text);
              }else{
